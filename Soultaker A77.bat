@echo off
mode 160,50
title SoulTaker MultiTool ~ Coded By A77
:menu
type menu.py
color 4
...
if '%action%'=='24' goto tiktokfollwbot
if '%action%'=='25' goto instagramid
if '%action%'=='26' goto Fn cheat
if '%action%'=='27' goto exit

:pinger
@echo off & cls
start %cd%\PROGRAMS\a77pinger.bat
goto menu

:booter
@echo off & cls
explorer "https://www.ipstresser.com/index.php?page=login&requested=stresser"
goto menu
...
:vpn
@echo off & cls
explorer "https://courvix.com/vpn"
goto menu
...
:steamgenerator
@echo off & cls
explorer "https://steam-account-creator.github.io/memes/"
goto menu
...
:tiktokfollwbot
@echo off & cls
explorer "https://github.com/simonfarah/TikTok-Bot"
goto menu
